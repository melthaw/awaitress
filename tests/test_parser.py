...
from awaitress.compat import text_, tobytes
...
class TestHTTPRequestParser(unittest.TestCase):
    ...
    def test_received_bad_transfer_encoding(self):
        from awaitress.utilities import ServerNotImplemented
    ...
    def test_received_cl_too_large(self):
        from awaitress.utilities import RequestEntityTooLarge
    ...
    def test_received_headers_too_large(self):
        from awaitress.utilities import RequestHeaderFieldsTooLarge
    ...
    def test_parse_header_no_cr_in_headerplus(self):
        from awaitress.parser import ParsingError
    ...
    def test_parse_header_transfer_encoding_invalid(self):
        from awaitress.parser import TransferEncodingNotImplemented
    ...
    def test_parse_header_transfer_encoding_invalid_unicode(self):
        ...
        # which if awaitress were to accidentally do the wrong thing get
...
class Test_split_uri(unittest.TestCase):
    def _callFUT(self, uri):
        from awaitress.parser import split_uri
...
class Test_get_header_lines(unittest.TestCase):
    def _callFUT(self, data):
        from awaitress.parser import get_header_lines
...
class Test_crack_first_line(unittest.TestCase):
    def _callFUT(self, line):
        from awaitress.parser import crack_first_line
